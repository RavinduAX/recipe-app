        ...
        <div className="modal-content flex flex-col gap-5 max-w-3xl px-8">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex justify-between items-center gap-10">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXL4M9tdr6AgJR8Ub-o9lS2_7HIKFa3yq66NhUn7RG&s" alt="recipeImage" className="rounded-lg flex-1 lg:h-56 sm:block hidden"/>
              {/* ingredients */}
              <ul className="flex-1 self-start hover:cursor-default h-56 overflow-y-auto">
            ...
            <div className="flex flex-col gap-5">
              <span className="hover:cursor-default h-52 overflow-y-auto">
                Preheat oven to 350° F. Spray a 9x13-inch baking pan with non-stick spray.\r\nCombine soy sauce, ½ cup water, brown sugar, ginger and garlic in a small saucepan and cover. Bring to a boil over medium heat. Remove lid and cook for one minute once boiling.\r\nMeanwhile, stir together the corn starch and 2 tablespoons of water in a separate dish until smooth. Once sauce is boiling, add mixture to the saucepan and stir to combine. Cook until the sauce starts to thicken then remove from heat.\r\nPlace the eat. Remove lid and cook for one minute once boiling.\r\nMeanwhile, stir together the corn starch and 2 tablespoons of water in a separate dish until smooth. Once sauce is boiling, add mixture to the saucepan and stir to combine. Cook until the sauce starts to thicken then remove from heat.\r\nPlace th chicken breasts in the prepared pan. Pour one cup of the sauce over top of chicken. Place chicken in oven and bake 35 minutes or until cooked through. Remove from oven and shred chicken 
              </span>
